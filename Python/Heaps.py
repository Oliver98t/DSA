...
class MaxHeap:
    ...
    def _sink_down(self, index):
        ...
        while True:
            ...
            if self.heap[max_index] < self.heap[left_index] and self.heap[max_index] < len(self.heap):
                max_index = left_index

            if self.heap[max_index] < self.heap[right_index] and self.heap[max_index] < len(self.heap):
                max_index = right_index
